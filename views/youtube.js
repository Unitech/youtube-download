...
var button = $('<button type="button" title="Click here and wait for download." class="yt-uix-tooltip yt-uix-button yt-uix-button-default" id="downloadbutton" data-tooltip-title="Click here and wait for download." data-tooltip-timer="1521"><img alt="" src="http://s.ytimg.com/yt/img/pixel-vfl73.gif" class="yt-uix-button-icon-watch-url"> <span class="yt-uix-button-content">Download as mp3</span></button>');
